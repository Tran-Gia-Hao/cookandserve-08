...
const OrderCart: React.FC<OrderCartProps> = ({
  ...
  return (
    <Sheet>
      ...
      <SheetContent className="sm:max-w-md w-[90vw] bg-[#fefaf3] flex flex-col">
        ...
        <div className="flex-none mt-4 mb-2">
        ...
        {menuType === 'buffet' && buffetItem && onPeopleCountChange && (
          <div className="flex-none mt-2 mb-2">
        ...
        <div className="flex-grow overflow-hidden flex flex-col">
          {menuType === 'buffet' && buffetItem ? (
            <>
              <div className="flex-none mb-4 p-4 bg-amber-50 border border-amber-200 rounded-md">
              ...
              <div className="text-base font-semibold mb-2 flex-none">Món đã chọn:</div>
            ...
            <div className="py-8 text-center text-gray-500 flex-grow">
              <p>Please select a buffet package first.</p>
            </div>
          )}
        </div>
        
        {/* Always show the order summary and button */}
        <div className="flex-none pt-4 mt-auto">
          ...
          <div>
            ...
            <Button 
              ...
              disabled={menuType === 'buffet' 
                ? (!tableNumber || tableNumber <= 0 || !peopleCount || peopleCount <= 0) 
                : (!tableNumber || tableNumber <= 0 || items.length === 0)}
            >
